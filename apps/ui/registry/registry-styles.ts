...
export const styles: Registry["items"] = [
  {
    ...
    description:
      "Complete FlutMan theme: colors, sidebar, fonts, and base styles. Use with `npx shadcn init @flutman/style` for full project setup.",
    devDependencies: ["tw-animate-css"],
    extends: "none",
    name: "style",
    registryDependencies: ["utils", "@flutman/ui", "@flutman/fonts"],
    type: "registry:style",
  },
  {
    cssVars: {
