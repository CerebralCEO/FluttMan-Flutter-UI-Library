import {
  ...
  PageHeaderHeading,
} from "@flutman/ui/shared/page-header";
import { SiteFooter } from "@flutman/ui/shared/site-footer";
...
export const metadata: Metadata = {
  description,
  title: "A new, modern UI component library built on top of Base UI - FlutMan",
};
