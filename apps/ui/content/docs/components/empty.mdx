...
<div className="mt-4 flex justify-end">
  <CopyAgentPrompt componentName="empty" />
</div>
...
The API design of this component is modeled after [shadcn/ui's empty component](https://ui.shadcn.com/docs/components/empty) to ensure familiarity and consistency for developers already using shadcn. This standardization makes it easier to adopt **flutman ui** while maintaining API parity with the patterns developers already know and love.
