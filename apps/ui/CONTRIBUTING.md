...
Thank you for your interest in contributing to flutman ui! This guide will help you understand how to contribute components and particles to our design system.

## Overview

**flutman ui** consists of two main types of components:
...
- `registryDependencies`: Array of UI components used (e.g., `["@flutman/button"]`, `["@flutman/input", "@flutman/label"]`)
...
- `registryDependencies` should reference `@flutman/*` package names
...
Thank you for contributing to flutman ui! 🎉
